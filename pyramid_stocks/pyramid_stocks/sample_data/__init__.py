MOCK_DATA = [
            {
                ...
                'description': 'General Electric Co is a digital industrial \
                 company. It operates in various segments, including power \
                 and water, oil and gas, energy management, aviation, \
                 healthcare, transportation, appliances and lighting, \
                 and more.',
                'CEO': 'John L. Flannery',
                'issueType': 'cs',
                'sector': 'Industrials'
            },
            {
                ...
                'description': 'Nunc tincidunt vitae diam at mollis. \
                Pellentesque luctus massa nec odio mollis feugiat. Praesent \
                vitae sapien quis diam viverra porttitor quis quis odio. \
                Suspendisse potenti. Donec vel metus sed nisl ultrices \
                ultricies non et mi. Suspendisse aliquam erat dolor, ac \
                semper nisi interdum vitae. Aliquam erat volutpat. \
                Aliquam quam libero, venenatis ac tortor ac, mattis \
                gravida lacus.',
                'CEO': 'Lorem ipsum',
                'issueType': 'cs',
            ...
            },
            {
                ...
                'description': 'Abbott Laboratories is an Illinois corporation,\
                 incorporated in 1900.  Abbott\'s* principal business is the\
                 discovery, development, manufacture, and  sale of a broad \
                 and diversified line of health care products.',
                'CEO': 'Lorem ipsum',
                'issueType': 'cs',
            ...
            },
            {
                ...
                'description': 'We are one of the nation?s leading diversified \
                 health care benefits companies,  serving approximately 36.7 \
                 million people with information and resources to help  them \
                 make better informed decisions about their health care. We \
                 offer a broad  range of traditional and consumer-directed \
                 health insurance products and related  services, including \
                 medical, pharmacy, dental, behavioral health, group life \
                 and disability plans, and medical management capabilities \
            ...
            {
                'symbol': 'OMI',
                'companyName': 'Owens & Minor',
                'exchange': 'New York Stock Exchange',
                'industry': 'Medical Specialities',
                'website': 'https://www.owens-minor.com/',
                'description': 'Owens & Minor, Inc. and subsidiaries (Owens & \
                 Minor, O&M or the company) is the  nation?s leading \
                 distributor of medical and surgical supplies to the \
                 acute-care  market, a healthcare supply-chain management \
                 company, and a national  direct-to-consumer supplier of \
                 testing and monitoring supplies for diabetics.',
                'CEO': 'Lorem ipsum',
                'issueType': 'cs',
                'sector': 'Health Care'
            },
